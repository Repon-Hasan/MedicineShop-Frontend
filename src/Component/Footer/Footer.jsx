  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10 px-6 md:px-20 animate-fadeIn">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* About MediMarket */}
        <div>
          <h3 className="text-xl font-bold mb-4 text-white">MediMarket</h3>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/discounted" className="hover:text-green-400 transition">Discounted Products</a></li>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-gray-400">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" aria-label="Facebook" className="hover:text-green-400 transition">
              <FaFacebookF size={20} />
            </a>
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="hover:text-green-400 transition">
